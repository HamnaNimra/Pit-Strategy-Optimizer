...
def test_explain_why_pit_window_opens():
    ...
    text = explain_why_pit_window_opens(pit_loss_sec=22.0, degradation_rate_sec_per_lap=0.1)
...
def test_explain_when_degradation_overtakes():
    ...
    text = explain_when_degradation_overtakes(pit_loss_sec=20.0, degradation_rate_sec_per_lap=1.0)
